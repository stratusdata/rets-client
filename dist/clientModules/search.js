...
(function() {
  ...
  query = function(resourceType, classType, queryString, options) {
    if (options == null) {
      options = {};
    }
    return new Promise((function(_this) {
      return function(resolve, reject) {
        ...
        currEntry = null;
        return _this.stream.query(resourceType, classType, queryString, options).pipe(through2.obj(function(event, encoding, callback) {
